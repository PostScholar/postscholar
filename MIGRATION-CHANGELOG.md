...
- **Connection String (Pooled):**  
  `postgresql://neondb_owner:npg_Bsy6AmthNjP2@ep-lively-queen-a6vatd1d-pooler.us-west-2.aws.neon.tech/neondb?sslmode=require&channel_binding=require`
- **Connection String (Direct):**  
  `postgresql://neondb_owner:npg_Bsy6AmthNjP2@ep-lively-queen-a6vatd1d.us-west-2.aws.neon.tech/neondb?sslmode=require`
